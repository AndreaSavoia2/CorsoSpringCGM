...
public class ReasonController {
    ...
    // serve esclusiovamente per l'inserimento di una nuova reason
    ...
    // cancellazione logica di una reason, ovvero invalidare la reson settando un data di fine validità
